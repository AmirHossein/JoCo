...
function getSubscriptions(uparent, id)
{
	...
	xmlHttp.open("GET" , "index.php?id=" + mKey + "&summary=1&getSubs=" + uparent, true);
	xmlHttp.onreadystatechange=function() 
	{
		if(xmlHttp.readyState==1)
			document.getElementById("subscriptions_" + id).innerHTML  = '<p><img src="' +sniPath+ 'images/loading.gif" />' +lang_loading+ '</p>';
