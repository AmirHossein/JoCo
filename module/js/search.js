...
function getNames(action)
{
	...
	xmlHttp.open("POST" , "index.php?a=112&id=" +mKey+ "&search=1", true);
	...
	xmlHttp.onreadystatechange=function() 
	{
		...
		if(xmlHttp.readyState==1)
			document.getElementById(stage).innerHTML  = '<p><img src="' +baseUrl+modulePath+ 'images/loading.gif" />' +lang_loading+ '</p>';
