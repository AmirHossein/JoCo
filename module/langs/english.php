<?php
/*********************************
Module : JoCo (Jot Comments module) : English language file
By : AHHP ~ Boplo.ir
Version: 0.9.2
*********************************/
...
// main page
$JoCo_lang['sectionHeader'] = "Jot Comments module";
$JoCo_lang['des_para'] = 'JoCo is a module for MODxCMS to manage all comments of <b>' .$modx->config['site_name']. '</b>.';
...
$JoCo_lang['jotcall'] = "Jot Calls";
$JoCo_lang['jotcall_para'] = 'Manage all Jot calls of site.';
...
$JoCo_lang['description'] = "Description";
...
$JoCo_lang['jotCallPermi'] = "Manage Jot Calls";
...
$JoCo_lang['jotCallResPerPagePermi'] = "Number of results in Jot Call part";
...
$JoCo_lang['add_user'] = "Add user!";
$JoCo_lang['remove_user'] = "Remove user!";
...
// jotcall
$JoCo_lang['jotcall_nothing_found'] = "Nothing found!<br />The Jot calls in this document may be generated by a <b>Snippet</b> or in a <b>Chunk</b>. Would you like to see <a href='index.php?a=112&id=" .$_GET['id']. "&jotCall=1&chunks=1'>Jot calls in Chunks</a>?";
$JoCo_lang['jotcall_get_calls'] = "Get calls";
$JoCo_lang['jotcall_show'] = "Show";
$JoCo_lang['jotcall_hide'] = "Hide";
$JoCo_lang['jotcall_part_para'] = 'You can see all Jot calls in your site and edit them here.<br />
This part gives you Jot calls in
	<ul>
		<li><a href="index.php?a=112&id=' .$_GET['id']. '&jotCall=1"><b>Document Content</b> and <b>Template Variables</b></a></li>
		<li><a href="index.php?a=112&id=' .$_GET['id']. '&jotCall=1&chunks=1"><b>Chunks</b></a></li>
	</ul>';
$JoCo_lang['jotcall_view_document_role'] = '<center><h2>Viewing documents details is not in your manager roles.</h2></center>';
